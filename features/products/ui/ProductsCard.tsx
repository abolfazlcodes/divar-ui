...
const ProductsCard: React.FC<Omit<ProductProps, "id">> = ({
  ...
  return (
    <Link className="inline-flex w-full xl:max-w-[32%]" href={href}>
      <article className="h-[11.5rem] p-3 w-full  border rounded-md cursor-pointer">
        <article className="mb-4 bg-white rounded-md flex w-full h-40 relative">
